...
export function Model({ ghostState, ...props }: ModelProps) {
  ...
  const idle = useGLTF('/models/janela-wait.glb')
  const chase = useGLTF('/models/janela-chase.glb')
  const scared = useGLTF('/models/janela-scared.glb')
...
useGLTF.preload('/models/janela-wait.glb')
useGLTF.preload('/models/janela-chase.glb')
useGLTF.preload('/models/janela-scared.glb')