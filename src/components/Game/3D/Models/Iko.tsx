...
export function Model({ ghostState, ...props }: ModelProps) {
  ...
  const idle = useGLTF('/models/iko-wait.glb')
  const chase = useGLTF('/models/iko-chase.glb')
  const scared = useGLTF('/models/iko-scared.glb')
...
useGLTF.preload('/models/iko-wait.glb')
useGLTF.preload('/models/iko-chase.glb')
useGLTF.preload('/models/iko-scared.glb')