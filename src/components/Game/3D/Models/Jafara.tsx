...
export function Model({ ghostState, ...props }: ModelProps) {
  ...
  const idle = useGLTF('/models/jafara-wait.glb')
  const chase = useGLTF('/models/jafara-chase.glb')
  const scared = useGLTF('/models/jafara-scared.glb')
...
useGLTF.preload('/models/jafara-wait.glb')
useGLTF.preload('/models/jafara-chase.glb')
useGLTF.preload('/models/jafara-scared.glb')