    ...
    <div className="absolute inset-0 z-50 flex flex-col items-center justify-center bg-black/85 backdrop-blur-sm animate-in fade-in duration-300">
      ...
      {gameStatus === 'idle' && (
        <div className="text-center flex flex-col items-center gap-6">
          ...
          <button 
            onClick={startGame}
            className="group relative px-12 py-4 bg-primary text-white text-xl font-bold rounded-full overflow-hidden shadow-[0_0_30px_var(--primary)] hover:scale-105 transition-all duration-300"
          >
